...
export const StrongExample: StoryObj<typeof Strong> = {
  render: (args) => (
    <Text>
      You can use the <Strong {...args}>{args.children}</Strong>. Ullam veritatis in qui, commodi enim
      earum obcaecati ipsam necessitatibus perferendis quas, mollitia est, sequi
      quam. Excepturi!
    </Text>
  ),
